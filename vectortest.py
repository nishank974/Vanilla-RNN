...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 16 18:30:58 2017

@author: user
"""

#Import Statements
import gensim, logging, nltk,os, sys, numpy as np, matplotlib.pyplot as plt
...
def preprocess():    
    fname = '/home/user/Downloads/data/combined20_test.txt'
...
def convert_text():
    ...
    np.savetxt('/home/user/Downloads/data/files from coe/dat_clean_test.txt', df1['text'].values, fmt='%s')
    return data
...
'''
#For plotting sentence vectors will be under sentence vector function
     t1=[]
...
model,final,vec_final=wordvectors('/home/user/Downloads/data/files from coe/dat_clean_test.txt',data)

test_data_excel = '/home/user/Downloads/data/files from coe/test20.xlsx'


X,y=sentencevectors(model,final,vec_final,test_data_excel)
